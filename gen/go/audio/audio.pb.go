...
type NoteUpload struct {
	...
	Note  int64  `protobuf:"varint,1,opt,name=note,proto3" json:"note,omitempty"`
...
func (x *NoteUpload) GetNote() int64 {
	if x != nil {
		return x.Note
	}
	return 0
...
var file_audio_audio_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x6e, 0x6f, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x63,
