...
func request_AudioStreamingService_Upload_0(ctx context.Context, marshaler runtime.Marshaler, client AudioStreamingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_AudioStreamingService_Upload_0(ctx context.Context, marshaler runtime.Marshaler, server AudioStreamingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UploadRequest
	var metadata runtime.ServerMetadata
...
func RegisterAudioStreamingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AudioStreamingServiceServer) error {
	...
	mux.Handle("POST", pattern_AudioStreamingService_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/audiostreaming.AudioStreamingService/Upload", runtime.WithHTTPPathPattern("/v1/audio"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AudioStreamingService_Upload_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_AudioStreamingService_Upload_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAudioStreamingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AudioStreamingServiceClient) error {
	...
	mux.Handle("POST", pattern_AudioStreamingService_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/audiostreaming.AudioStreamingService/Upload", runtime.WithHTTPPathPattern("/v1/audio"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AudioStreamingService_Upload_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_AudioStreamingService_Upload_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "audio"}, ""))
)

var (
	forward_AudioStreamingService_Upload_0 = runtime.ForwardResponseMessage
)
